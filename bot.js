...
https.createServer({
	...
	cert: fs.readFileSync('../ssl-certificate/2ccbe2f94a644631.crt'),
	ca: [fs.readFileSync('../ssl-certificate/gd1.crt'),
	fs.readFileSync('../ssl-certificate/gd2.crt'),
	fs.readFileSync('../ssl-certificate/gd3.crt')]
},app).listen(8443)
